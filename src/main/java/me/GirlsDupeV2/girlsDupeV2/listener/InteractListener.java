...
public class InteractListener implements Listener {
    ...
    public void onSit(PlayerInteractEvent e) {
        ...
        GirlsDupeV2 instance = GirlsDupeV2.getInstance();
        ...
        Entity entity = p.getWorld().spawn(loc, Objects.requireNonNull(EntityType.valueOf(entityType).getEntityClass()), (stair -> {
            ...
            if (stair instanceof Attributable attributable) {
                ...
                Objects.requireNonNull(attributable.getAttribute(Attribute.GENERIC_MOVEMENT_SPEED)).setBaseValue(0);
